    ...
    <div className={styles.container}>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className={styles.grid}>
        ...
        <div className={styles.inputFull}>
          ...
          <input {...register("businessName")} placeholder="Legal Business Name" className={styles.input} />
        ...
        <div>
          ...
          <select value={selectedState} onChange={handleStateChange} className={styles.select} disabled={!states}>
            <option value="">Select State</option>
            {states?.states?.map((s) => (
              <option key={s._id} value={s._id}>{s.name}</option>
            ))}
          </select>
          {errors.address?.state && <p className={styles.error}>{errors.address.state.message}</p>}
        </div>

        {/* City */}
        <div>
          <label className={styles.label}>City</label>
          <select onChange={handleCityChange} className={styles.select} disabled={!cities}>
